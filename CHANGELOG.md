...
* reject every write to the read-only facts with a message, and name a null argument in the result and exception factories ([#681](https://github.com/brantunger/unruly-engine/issues/681)) ([389125a](https://github.com/brantunger/unruly-engine/commit/389125a6ff60ffb8e200d1373d36b4922d2ab090))

## [2.8.1](https://github.com/brantunger/unruly-engine/compare/v2.8.0...v2.8.1) (2026-09-26)


### Bug Fixes

* log a nested run's failure once, where it happened, and a fatal Error once per thread ([#676](https://github.com/brantunger/unruly-engine/issues/676)) ([b4913d3](https://github.com/brantunger/unruly-engine/commit/b4913d3b37ccf981ba5134f1bca73dad0d7aa23f))
...
* report an MVEL declaration of an unknown type without MVEL's parser context, and MVEL's raw declaration, NPE and nested errors as syntax errors ([#645](https://github.com/brantunger/unruly-engine/issues/645)) ([a491fb4](https://github.com/brantunger/unruly-engine/commit/a491fb453ab203bdeb7b18749cf6eb281749767b))

## [2.7.9](https://github.com/brantunger/unruly-engine/compare/v2.7.8...v2.7.9) (2026-09-25)


### Bug Fixes

* report MVEL's out-of-bounds parse errors, strong-typing error lists and failed asserts as one-line descriptions ([#640](https://github.com/brantunger/unruly-engine/issues/640)) ([aee9a5d](https://github.com/brantunger/unruly-engine/commit/aee9a5df5162dd2a7c8c88a6d18dbf95413b8af0))
...
* escape every Unicode format character in log lines and messages, never cut a surrogate pair, and correct five doc claims ([#609](https://github.com/brantunger/unruly-engine/issues/609)) ([a7375c5](https://github.com/brantunger/unruly-engine/commit/a7375c5b17915c5d95f8ec1f468d70bbe18d9995))
...
* refuse a value of another type at an override's bridge setter instead of failing with ClassCastException ([#550](https://github.com/brantunger/unruly-engine/issues/550)) ([e95b279](https://github.com/brantunger/unruly-engine/commit/e95b279c66d60bf136975d7b2edf2d7f3ef0a8ee))
