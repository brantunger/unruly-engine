 ...
 *
 * <p>
 * The engine sets the properties in the order of the map, after the action returns: on a {@link Map} output with
 * {@code put}, and on any other output with its public setter, such as {@code setInterestRate} for
